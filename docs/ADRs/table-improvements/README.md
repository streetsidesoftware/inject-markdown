...
ADRs for table-injection options (`header-rows`, `columns`, row windowing, auto-alignment). Numbering restarts at `0001` within this group; see [../README.md](../README.md) for the overall ADR convention.
